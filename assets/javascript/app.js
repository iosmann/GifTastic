...
var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + window.encodeURI(type)  + "&api_key=s8kOv73tIVIy3Q7DejVKXpOJwn5ypE9D&limit=25";
...
$(document).on("click", ".singer", displaySinger);
